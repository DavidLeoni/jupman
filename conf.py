...
jm.write_solution_here = jmt.ignore_spaces("# write here")

#NOTE: the following string is not just a translation, it's also a command that  when building the exercises  completely removes the content of the cell it is contained in (solution comment included). If the user inserts extra spaces the phrase will be recognized anyway
...
jm.ipynb_title = r"(\s*#.*)(" + jm.ipynb_solution + r")"
...
def setup(app):    
        ...
        jm.zip_folders('exams', prefix=jm.filename + '-', suffix='-exam')
